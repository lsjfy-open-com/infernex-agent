module gitcode.com/openFuyao/InferNex/component/InferNex-Agent

go 1.24.5

require (
	gitcode.com/openFuyao/InferNex v0.0.0
...
replace gitcode.com/openFuyao/InferNex => ../InferNex-Bridge

// Keep this aligned with InferNex-Bridge until its dependency graph moves
// forward as a unit.
