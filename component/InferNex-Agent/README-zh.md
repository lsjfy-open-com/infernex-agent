...
它复用已有的 `InferNexService`、InferNex Bridge、vLLM/vLLM-Ascend、Mooncake、
Hermes、PD Orchestrator、Eagle-Eye 和 infernex-checker，不建立第二套推理编排器。
...
- Kubernetes/InferNex CRD、status、Event、Pod 日志和拓扑；
