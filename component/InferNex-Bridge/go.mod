module gitcode.com/openFuyao/InferNex
...
// Keep controller-runtime pinned to v0.19.x for compatibility with the current dependency graph.
// Not tied to .7 specifically; tidy may bump the require line.
