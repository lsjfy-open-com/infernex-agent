...
开始改动前请参考[模块边界和 PR 演进计划](component/InferNex-Agent/docs/module-boundaries-and-pr-plan-zh.md)，
功能状态以[工具目录](component/InferNex-Agent/docs/mcp-tool-catalog-zh.md)和
[路线图](component/InferNex-Agent/docs/v0.5-roadmap-zh.md)为准。
...
普通 PR 从当前 `main` 建立；依赖尚未合入的 PR 时，可以使用堆叠分支：
...
[候选验收清单](component/InferNex-Agent/docs/candidate-validation-zh.md)声明的合入、发版门槛；
...
普通 merge 可用 `git merge-base --is-ancestor <branch> origin/main` 验证提交已被保留；
