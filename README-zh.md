...
**当前边界**：alpha.13 已有完整 Pi TUI、证据/诊断和 Bridge 受控部署/恢复；原生按规格自动部署、请求级均衡和通用故障闭环仍待实现。不要把架构目标当成已发布功能。详见[能力矩阵与分层契约](component/InferNex-Agent/docs/architecture/kubernetes-first-zh.md)。

- 安装实验包：[alpha.13 Release](https://github.com/lsjfy-open-com/infernex-agent/releases/tag/infernex-agent-v0.5.0-alpha.13)，按管理节点架构选择归档及校验文件，解压后 `sudo ./install.sh`。
