...
- **InferNex-Bridge**: Adaptation layer for integrating InferNex with KServe, supporting dual CRD declarative deployment of InferNex via `LLMInferenceService` / `InferNexService`. See [Component README](../../component/InferNex-Bridge/README-en.md).
